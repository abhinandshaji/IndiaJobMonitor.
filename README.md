...
✅ Job trend monitoring
✅ Industry news aggregation with sentiment classification (Red / Amber / Green)
...
**Testing method:** Organic traffic via LinkedIn soft launch + in-app feedback form (hashed IP for unique response tracking).
**Minimum required:** 400 feedback responses at 95% confidence, 5% margin of error.

**Contributing**

Found a bug or missing job source? 
Raise an issue directly on GitHub — every report helps improve the MVP. Go to the Issues tab. Describe the problem or suggestion. Submit!
